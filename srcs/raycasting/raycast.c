...
/*   Updated: 2025/03/25 21:29:01 by rbardet-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int raycast(t_cub *cub)
{
	...
	while (x < cub->win_width) // Loop for the entire screen width
	{
		...
		if (side == 0)
			color = (t_rgb){255, 0, 0};  // Red for horizontal walls
		else
			color = (t_rgb){0, 0, 255};  // Blue for vertical walls

		// Print debug info to check ray progress
